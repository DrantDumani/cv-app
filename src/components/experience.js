...
class Experience extends Component {
    ...
    render(){
        ...
        const {position, employer, from, to, id, fieldIds} = this.props.experience
        ...
        return (
            <div>
                <div>
                    ...
                    <input value={position} id={`${positionId}${id}`} onChange={(e) => {handleChange(e, id)}} />
                </div>
                <div>
                    <label htmlFor={`${employerId}${id}`}>Employer: </label>
                    <input value={employer} id={`${employerId}${id}`} onChange={(e) => {handleChange(e, id)}} />
                </div>
                <div>
